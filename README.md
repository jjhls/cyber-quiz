...
```bash
# 克隆项目
git clone https://github.com/jjhls/cyber-quiz.git
cd cyber-quiz
...
| PUT | `/api/user/avatar` | 设置头像 |
| GET | `/api/avatars` | 获取内置头像列表 |
| GET | `/api/user/history` | 获取参赛记录 |
| GET | `/api/user/answers` | 获取答题统计 |
| GET | `/api/user/stats/trend` | 获取趋势数据 |
